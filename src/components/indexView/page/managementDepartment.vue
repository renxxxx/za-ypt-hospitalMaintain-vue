    ...
    <div class="userManagement scrollStyle">
        <div class="userManagement_topTitle">
            ...
            <div class="userManagement_title">
                <router-link :to="{path: '/index/managementDepartment',query:{time:new Date().getTime().toString()}}">
                    <span>科室管理</span>
                </router-link>
            </div>
            ...
            <div class="userManagement_table_box">
                ...
                <el-table ref="singleTable" :data="tableDataList" highlight-current-row  
                    ...
                    <el-table-column label="更新时间">
                        <template slot-scope="scope">
                            <div class="line-1" :title="scope.row.nowUpdateTime">{{scope.row.nowUpdateTime}}</div>
                        </template>
                    </el-table-column>
                    <el-table-column label="操作" prop="修改" width="124">
                        <template slot-scope="scope">
                           <span style="cursor: pointer;color: #1890FF" @click="modifyFn(scope.row)" title="修改此科室信息">修改</span>
                           <span style="color : #E9E9E9"> | </span>
                           <span style="cursor: pointer;color: #FF1A2E" @click="modifySubmitDialogShowFn(false,scope.row)" title="删除此科室">删除</span>
                        </template>
                    </el-table-column>
                </el-table>
            </div>
